...
const About = () => {
  return (
    <div
      className="w-full flex lg:flex-row flex-col items-end relative lg:py-20 py-44"
      id="about"
    >
