  ...
  return (
    ...
    >
      <div className="flex flex-col items-center flex-1 px-20 mt-32 lg:items-start lg:mt-0 z-[99]">
        <Image
          src={theme == "dark" ? "/i/i1.jpg" : "/hero04.png"}
          alt=""
          width={250}
          height={250}
        ...
        <p className="text-center dark:text-gray-200  lg:text-left animate__animated animate__fadeInLeft">
          {theme == "dark"
            ? "I am great at torturing chatgpt to code my projects"
            : "I am a great programmer with spirit for future"}
        </p>
        <button
          onClick={() => scrollTo("contact")}
          className="px-5 py-2 mt-5 text-white rounded-full dark:bg-gray-200 dark:text-gray-800 bg-gray-800 text-gray-200 dark:hover:bg-gray-300 hover:bg-slate-600"
        >
          Contact Me
        </button>
      </div>
